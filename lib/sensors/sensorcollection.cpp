...
void sensorCollection::discover() {
    ...
    addSensor(measurementChannel::batteryLevel, 3, 59, 3, 9);        // test Version
    ...
    if (bme680::isPresent()) {
        ...
        addSensor(measurementChannel::BME680SensorTemperature, 3, 59, 3, 9);               // test
        addSensor(measurementChannel::BME680SensorRelativeHumidity, 3, 59, 3, 9);          // test
        addSensor(measurementChannel::BME680SensorBarometricPressure, 3, 59, 3, 9);        // test
    }
